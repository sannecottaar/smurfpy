...
#CCP.plot_topography(380, 440,name=name,filter=rffilter,conversion=conversion,factor=factor,mincoverage=40., amplitude = False, blobs = False)
#CCP.plot_mtzwidth(filter=rffilter, conversion=conversion, factor=factor, mincoverage=40.)
#CCP.plot_mtzwidth_write(filter=rffilter, conversion=conversion, factor=factor)
